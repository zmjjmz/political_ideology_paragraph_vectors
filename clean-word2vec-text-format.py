#!/usr/bin/python2
# Shamelessly taken from https://github.com/3Top/word2vec-api/blob/master/clean-word2vec-text-format.py and fixed to work with glove
# i.e. no headers
# Put this in the same folder as the 840B glove vectors. Note that the modified file will have a header, which is fine.
import codecs
import os
import shutil
import time
...
vsize = 0
with open(SOURCE,mode='r') as temp:
  for line in temp:
    vsize += 1
print "%d lines" % vsize
count = 0
